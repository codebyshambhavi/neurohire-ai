      ...
      <div className="flex flex-col gap-6">
        <div className="rounded-2xl border border-border bg-card/50 p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-semibold tracking-tight text-foreground">Alex Johnson</h2>
              <p className="text-sm text-muted-foreground">ML Engineer · Professional</p>
        ...
        <div className="flex flex-col items-center rounded-2xl border border-border bg-card/50 p-6">
          <h3 className="text-sm font-medium text-muted-foreground">Current NeuroScore</h3>
          <div className="mt-4">
          ...
          <form className="mt-6 flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input id="profile-role" defaultValue="ML Engineer" />
              </div>
            </div>
            <div className="flex flex-col gap-2">
              <Label htmlFor="profile-email">Email</Label>
              <Input id="profile-email" type="email" defaultValue="alex.johnson@example.com" />
            </div>
            ...
            {achievements.map((item) => (
              <li
                ...
                className={cn(
                  ...
                  item.unlocked ? 'bg-background/40' : 'opacity-50',
                )}
              >
